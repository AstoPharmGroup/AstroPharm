using AstroPharm.Data.SeedData;
...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        BannerSeed.SeedBanners(modelBuilder);
        BranchSeed.SeedBranches(modelBuilder);
        CartItemSeed.SeedCartItems(modelBuilder);
        CatalogSeed.SeedCatalogs(modelBuilder);
        CategorySeed.SeedCategories(modelBuilder);
        LanguageSeed.SeedLanguages(modelBuilder);
        LocationSeed.SeedLocations(modelBuilder);
        MedicationSeed.SeedMedications(modelBuilder);
        OrderDetailSeed.SeedOrderDetails(modelBuilder);
